  ...
  function installReels() {
    ...
    function openCutoutEditor() {
      ...
      wrap.innerHTML = '<div class="reel-cutout-main-row">'
        ...
        + '</div>'
        + '<div class="reel-cutout-footer"><button type="button" class="reel-cutout-reset"><svg viewBox="0 0 32 32" aria-hidden="true"><path d="M9 10H3V4"/><path d="M4 10a13 13 0 1 1-1 10"/></svg><span>Reset</span></button><button type="button" class="reel-cutout-done" aria-label="Done"><svg viewBox="0 0 32 32"><path d="M6 17l7 7L27 8"/></svg></button></div>';
      let cutoutView = 'main';
